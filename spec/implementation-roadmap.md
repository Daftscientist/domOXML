...
8. [ ] Complete the remaining effect families. Implemented behavior and evidence live in the
   ...
   combinations; non-centered/focal radial fill overlays and broader pattern presets;
   multi-function SVG filter ordering beyond the strict soft-edge and fill-overlay
