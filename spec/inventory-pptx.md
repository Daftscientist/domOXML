...
| `preset-shadow-raster-fallback` | reverse | perspective preset shadow remains visible through one measured full-slide raster fallback, retains exact native source, and converges after the fallback boundary |
