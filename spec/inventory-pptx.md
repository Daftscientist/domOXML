...
| `gradient-fill-overlay` | both | linear/radial gradient overlay IR, premultiplied-sRGB native projection, exact guarded authored intent, portable renderer branch, malformed-fill preservation, Graph/LibreOffice evidence, and two-cycle convergence |
