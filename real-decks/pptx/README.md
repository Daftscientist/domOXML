...
These external-source and external-producer decks exercise package shapes that isolated HTML
fixtures do not.
...
The fill-overlay deck was generated by
[`Aspose.Slides FOSS for Python`](https://github.com/aspose-slides-foss/Aspose.Slides-FOSS-for-Python)
at commit `6ca17fd6593e0f31ed5e6fb53eb4c5896b7a6525` under MIT. Its redistributed license is in
[`LICENSE.Aspose-Slides-FOSS`](LICENSE.Aspose-Slides-FOSS). The pinned producer output covers the
